...
public class SpecialDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button specBack = findViewById(R.id.specButton1);
        Button specReg = findViewById(R.id.specButton2);
        ...
        specReg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SpecialDetail.this, Register.class);
