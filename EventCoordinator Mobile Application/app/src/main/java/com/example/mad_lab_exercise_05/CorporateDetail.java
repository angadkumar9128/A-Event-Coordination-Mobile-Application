...
public class CorporateDetail extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_corporate_detail);
        Button corBack = findViewById(R.id.corBut1);
        Button corReg = findViewById(R.id.corBut2);

        corBack.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        corReg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CorporateDetail.this, Register.class);
